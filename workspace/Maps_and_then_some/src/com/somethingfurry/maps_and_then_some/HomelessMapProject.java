...
public class HomelessMapProject extends PApplet {
	...
	public static final String ADDR_WIIB = "/wii/1/button/B";
	...
	public void setup() {
		...
		oscP5.plug(this, "toggleWii", ADDR_WIIB);
	...
	void initMarkers() {
		...
		// E 7th St.
				...
				// Ash and University
				Location ashAndUniv = new Location(33.4210f, -111.9424f);
				...
				Location millAve_hangout_photo_02 = new Location(33.4250f, -111.9334f);
				...
				// Edison Park
				Location edisonPark = new Location(33.4585f, -112.0400f);
				...
				Location vEdisonPark = new Location(33.4580f, -112.0406f);
				...
				Location hancePark_movie = new Location(33.4633f, -112.0733f);
				...
				Location e7thSt_demo = new Location(33.4358f, -111.8940f);
				DemoInfo demo1 = new DemoInfo();
				demo1.add(DemographicType.AGE, "Average 21");
				demo1.add(DemographicType.TIME_ON_STREET, "Average three months");
				demo1.add(DemographicType.PERCENT_FEMALE, "66.7%");
				demo1.add(DemographicType.PERCENT_MALE, "33.3%");
				demo1.add(DemographicType.PLACE_OF_ORIGIN, "Cedar City, Iowa: 33.3%; Unknown: 66.7%");
				demo1.add(DemographicType.EAT, "Tumbleweeds: 33.3%; Unknown: 66.7%");
				demo1.add(DemographicType.ELECTRICITY, "Tumbleweeds: 33.3%; Unknown: 66.7%");
				demo1.add(DemographicType.HANGOUT, "Tumbleweeds: 33.3%; Unknown: 66.7%");
				demo1.add(DemographicType.SLEEP, "Tumbleweeds: 33.3%; Unknown: 66.7%");
				demo1.add(DemographicType.RELATIONSHIP, "Married: 33.3%; Engaged: 33.3%; Unknown: 33.4%");
				demo1.add(DemographicType.PREGNANT, "Pregnant: 33.3%");
				LocationMapMarker dE7thSt_demo = new DemographcMapMarker(e7thSt_demo, this, map, demo1);
				markers.add(dE7thSt_demo);
				
				Location ashAndUniv_demo = new Location(33.4222f, -111.9424f);
				DemoInfo demo2 = new DemoInfo();
				demo2.add(DemographicType.AGE, "Average 19");
				demo2.add(DemographicType.TIME_ON_STREET, "Average three years");
				demo2.add(DemographicType.PERCENT_FEMALE, "50%");
				demo2.add(DemographicType.PERCENT_MALE, "50%");
				demo2.add(DemographicType.PLACE_OF_ORIGIN, "Prescott, AZ: 50%; CA: 50%");
				demo2.add(DemographicType.SUICIDE_ATTEMPT, "Attempted: 50%");
				demo2.add(DemographicType.SLEEP, "Couch Hope: 50; Unknown: 50%");
				LocationMapMarker dAshAndUniv_demo = new DemographcMapMarker(ashAndUniv_demo, this, map, demo2);
				markers.add(dAshAndUniv_demo);
				
				Location millAve_demo = new Location(33.4208f, -111.9380f);
				DemoInfo demo3 = new DemoInfo();
				demo3.add(DemographicType.AGE, "Average 18");
				demo3.add(DemographicType.TIME_ON_STREET, "Average fourteen months");
				demo3.add(DemographicType.PERCENT_FEMALE, "0%");
				demo3.add(DemographicType.PERCENT_MALE, "100%");
				demo3.add(DemographicType.HANGOUT, "MakeShift Tree House: 100%");
				demo3.add(DemographicType.SLEEP, "Indian School Park: 100%");
				demo3.add(DemographicType.EAT, "Dennys: 100%");
				demo3.add(DemographicType.BATHROOMS, "Dennys: 100%");
				LocationMapMarker dMillAve_demo = new DemographcMapMarker(millAve_demo, this, map, demo3);
				markers.add(dMillAve_demo);
				
				Location eastRoosevelt_demo = new Location(33.4570f, -111.9250f);
				DemoInfo demo4 = new DemoInfo();
				demo4.add(DemographicType.AGE, "Average 20");
				demo4.add(DemographicType.TIME_ON_STREET, "Average seven months");
				demo4.add(DemographicType.PERCENT_FEMALE, "50%");
				demo4.add(DemographicType.PERCENT_MALE, "50%");
				demo4.add(DemographicType.SUICIDE_ATTEMPT, "Attempted: 50%");
				demo4.add(DemographicType.SLEEP, "Family Crisis Center: 50%; Unknown: 50%");
				demo4.add(DemographicType.EAT, "Family Crisis Center: 50%; Unknown: 50%");
				demo4.add(DemographicType.RELATIONSHIP, "Deserted from family: 50%");
				LocationMapMarker dEastRoosevelt_demo = new DemographcMapMarker(eastRoosevelt_demo, this, map, demo4);
				markers.add(dEastRoosevelt_demo);
				
				Location hancePark_demo = new Location(33.4630f, -112.0750f);
				DemoInfo demo5 = new DemoInfo();
				demo5.add(DemographicType.AGE, "Average 22");
				demo5.add(DemographicType.TIME_ON_STREET, "Average five months");
				demo5.add(DemographicType.PERCENT_FEMALE, "50%");
				demo5.add(DemographicType.PERCENT_MALE, "50%");
				demo5.add(DemographicType.SLEEP, "Raphael Life House: 50%; Unknown: 50%");
				demo5.add(DemographicType.EAT, "Raphael Life House: 50%; Unknown: 50%");
				demo4.add(DemographicType.SUICIDE_ATTEMPT, "Attempted: 50%");
				LocationMapMarker dMargaretTHancePark_demo = new DemographcMapMarker(hancePark_demo, this, map, demo5);
				markers.add(dMargaretTHancePark_demo);
	...
	void oscEvent(OscMessage message) {
		...
		// use the acceleration to change position.
		  ...
		  if( message.checkAddrPattern(ADDR_WIIACCEL) ) { 
			     ...
			     //if it gets an osc message here, then yes, use the wii
	...
	{	
		if (!useWii) curLocation = map.getLocationFromScreenPosition(posX.value(), posY.value());
	}
